...
run chmod -R a+rwx .
run cd portal; composer install --ignore-platform-reqs; echo -e "DB_HOST = localhost\n\
DB_NAME = webtopup\n\
DB_USER = root\n\
DB_PASS = " > .env
run cd backoffice; composer install --ignore-platform-reqs; echo -e"DB_HOST = localhost\n\
DB_NAME = webtopup\n\
DB_USER = root\n\
DB_PASS = " > .env
